    ...
    return (
        <div className="max-w-3xl mx-auto px-4 py-10">
            ...
            <div className="flex items-center justify-between mb-6">
                <p>
                    <strong className="font-medium">Kategoria:</strong> {recipe.category}
                </p>
            ...
            <div className="grid grid-cols-3 gap-4 text-center mb-8">
                <div className="bg-yellow-100 rounded-xl py-4 shadow">
                    ...
                    <p className="text-base lg:text-xl font-bold">{recipe.calories} kcal</p>
                </div>
                <div className="bg-blue-100 rounded-xl py-4 shadow">
                    <p className="text-sm text-gray-600">Białko</p>
                    <p className="text-base lg:text-xl font-bold">{recipe.protein} g</p>
                </div>
